<!-- resources/views/pendaftaran/prestasi.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Form Pendaftaran Zona Prestasi</title>
...
<body>
    <h1>Form Pendaftaran Zona Prestasi</h1>
    <!-- Form mengarah ke route yang tepat -->
    <form action="{{ route('pendaftaran.zona_prestasi.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <script>
            ...
            <div style="margin-top: 20px;">
                ...
                <input type="file" name="sertifikat[]" accept="image/*" onchange="previewImage(event, 'sertifikatPreview', 'sertifikatDelete', false)" id="sertifikatInput">
                <br>
                <img id="sertifikatPreview" style="display:none; width: 150px; height: 150px; margin-top: 10px;">
                <br>
                <button type="button" id="sertifikatDelete" style="display:none;" onclick="deleteImage('sertifikatInput', 'sertifikatPreview', 'sertifikatDelete', false)">Hapus Gambar</button>
                <br><br>
